...
export const projToAwsProjDef = (proj: LocalIndexRequirement['projection']): Projection => {
  const type =
...
export const attrToAwsKeySchemaDef = (keyType: KeyType, attr: KeyAttribute): KeySchemaElement => {
  return {
    AttributeName: attr.name,
    KeyType: keyType,
  };
